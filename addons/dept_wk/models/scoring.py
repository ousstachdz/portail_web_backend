...
list_fisc = [
    ...
    'رأس المال',
    'الاحتياطات',
    'الارباح المتراكمة (محتجزة+محققة)',
    'حقوق الملكية / مجموع الميزانية',
    'ACTIF NET IMMOBILISE CORPOREL',
    ...
    'التزامات بنكية',
    'تسهيلات الموردين',
    'ضرائب مستحقة غير مدفوعة',
    'مطلوبات أخرى متداولة',
    'الالتزامات تجاه البنوك / حقوق',
    'مجموع الميزانية',
    '(المبيعات، الايرادات)',
    'صافي الارباح/المبيعات ROS',
...
class Scoring(models.Model):
    ...
    def import_data_group_alternative(self):
        print('import_data_group_alternative execed ')
        list_fiscs = [
            "حقوق الملكية",
            "رأس المال",
            "الاحتياطات",
        ...
        for rec in self:
            if rec.tcr_id.state not in ['valide', 'modified'] or rec.actif_id.state not in ['valide', 'modified'] or rec.passif_id.state not in ['valide', 'modified']:
                raise ValidationError("Vous devriez d'abord valider les bilans")
                    ...
                    bilan_0 = rec.companies_fisc.filtered(lambda r: r.sequence == 0)
                    bilan_0.write({'year_2': rec.annee_fiscal - 2,
                    ...
                    bilan_1.write({'year_4': passif_1.montant_n,
                                ...
                                'year_2': passif_1.montant_n,
                                'year_1': passif_1.montant_n1})
                    ...
                    bilan_2.write({'year_4': passif_2.montant_n,
                                ...
                                'year_2': passif_2.montant_n,
                                'year_1': passif_2.montant_n1,
                                })
                    ...
                    bilan_3.write({'year_4': passif_3.montant_n,
                                ...
                                'year_2': passif_3.montant_n,
                                'year_1': passif_3.montant_n1})
                    ...
                    bilan_4.write({'year_4': passif_3.montant_n + tcr_3.montant_n,
                                ...
                                'year_2': passif_3.montant_n + tcr_3.montant_n,
                                'year_1': passif_3.montant_n1 + tcr_3.montant_n1})
                    ...
                    passif1_12 = rec.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 25)
                    bilan_5.write({'year_4': (passif_1.montant_n / passif_12.montant_n) * 100 if passif_12.montant_n != 0 else 0,
                                ...
                                'year_2': (passif_1.montant_n / passif1_12.montant_n) * 100 if passif_12.montant_n != 0 else 0,
                                'year_1': (passif_1.montant_n1 / passif_12.montant_n1) * 100 if passif_12.montant_n1 != 0 else 0})
                    ...
                    passif_24 = rec.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 24)
                    bilan_10 = rec.companies_fisc.filtered(lambda r: r.sequence == 6)
                    ...
                    bilan_10.write({'year_4': actif_27.montant_n - passif_24.montant_n,
                                    ...
                                    'year_2': actif_27.montant_n - passif_24.montant_n,
                                    'year_1': actif_27.montant_n1 - passif_24.montant_n1,
                                    })
                    ...
                    passif_5 = rec.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 23)
                    bilan_11 = rec.companies_fisc.filtered(lambda r: r.sequence == 7)
                    ...
                    bilan_11.write({'year_4': actif_27.montant_n - actif_126.montant_n - (passif_24.montant_n - passif_5.montant_n),
                                    ...
                                    'year_2': actif_27.montant_n - actif_126.montant_n - (passif_24.montant_n - passif_5.montant_n),
                                    'year_1': actif_27.montant_n1 - actif_126.montant_n1 - (passif_24.montant_n1 - passif_5.montant_n1),
                                    })
                    ...
                    bilan_12 = rec.companies_fisc.filtered(lambda r: r.sequence == 8)
                    ...
                    bilan_13 = rec.companies_fisc.filtered(lambda r: r.sequence == 9)
                    ...
                    bilan_13.write({'year_4': passif_5.montant_n + passif_6.montant_n, 
                                    ...
                                    'year_2': passif_5.montant_n + passif_6.montant_n, 
                                    'year_1': passif_5.montant_n1 + passif_6.montant_n1, 
                                    })

                    # التزامات بنكية
                    bilan_14 = rec.companies_fisc.filtered(lambda r: r.sequence == 10)
                    passif_5 = rec.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 23)
                    passif_5 = rec.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 23)
                    ...
                    # تسهيلات الموردين
                    bilan_15 = rec.companies_fisc.filtered(lambda r: r.sequence == 11)
                    ...
                    bilan_15.write({'year_4': passif_7.montant_n,
                                ...
                                'year_2': passif_7.montant_n,
                                'year_1': passif_7.montant_n1})

                

                    # Passif - Impôts مستحقات ضرائب
                    bilan_16 = rec.companies_fisc.filtered(lambda r: r.sequence == 12)
                    ...
                    bilan_16.write({'year_4': passif_8.montant_n,
                                ...
                                'year_2': passif_8.montant_n,
                                'year_1': passif_8.montant_n1,
                                })

                    #Passif - Autres dettes + fournisseur  مطلوبات أخرى متداولة
                    bilan_17 = rec.companies_fisc.filtered(lambda r: r.sequence == 13)
                    ...
                    bilan_18 = rec.companies_fisc.filtered(lambda r: r.sequence == 14)
                    ...
                    if passif_1.montant_n < 0:
                        bilan_18.write({
                                    ...
                                    'year_2': (passif_18.montant_n + passif_24.montant_n) / passif_1.montant_n if passif_1.montant_n != 0 else 0,
                                    'year_1': (passif_18.montant_n1 + passif_24.montant_n1) / passif_1.montant_n1 if passif_1.montant_n1 != 0 else 0,
                                    })
                    ...
                    bilan_19 = rec.companies_fisc.filtered(lambda r: r.sequence == 15)
                    bilan_19.write({'year_4': bilan_14.year_4 / passif_1.montant_n if passif_1.montant_n != 0 else 0,
                                    ...
                                    'year_2': bilan_14.year_2 / passif_1.montant_n if passif_1.montant_n != 0 else 0,
                                    'year_1': bilan_14.year_1 / passif_1.montant_n1 if passif_1.montant_n1 != 0 else 0,
                                    })

                

                    # مجموع الميزانية
                    bilan_20 = rec.companies_fisc.filtered(lambda r: r.sequence == 16)
                    bilan_20.write({'year_4': passif_12.montant_n,
                                    'year_3': passif_12.montant_n1,
                                    'year_2': passif_12.montant_n,
                                    'year_1': passif_12.montant_n1
                                    })
                    # المبيعات ، الايرادات
                    bilan_21 = rec.companies_fisc.filtered(lambda r: r.sequence == 17)
                    ...
                    bilan_21.write({'year_4': tcr_1.montant_n,
                                    ...
                                    'year_2': tcr_1.montant_n,
                                    'year_1': tcr_1.montant_n1
                                    })

                    # TCR- Excédent brut d`exploitation   EBITDA
                    bilan_22 = rec.companies_fisc.filtered(lambda r: r.sequence == 18)
                    ...
                    bilan_22.write({'year_4': tcr_2.montant_n,
                                    ...
                                    'year_2': tcr_2.montant_n,
                                    'year_1': tcr_2.montant_n1})

                    # TCR - Résultat net de l`exercice   صافي الأرباح
                    bilan_23 = rec.companies_fisc.filtered(lambda r: r.sequence == 19)
                    tcr_3 = rec.tcr_id.tcr_lines.filtered(lambda r: r.rubrique.sequence == 50)
                    tcr_3 = rec.tcr_id.tcr_lines.filtered(lambda r: r.rubrique.sequence == 50)
                    bilan_23.write({'year_4': tcr_3.montant_n,
                                    'year_3': tcr_3.montant_n1,
                                    'year_2': tcr_3.montant_n,
                                    'year_1': tcr_3.montant_n1})

                    bilan_24 = rec.companies_fisc.filtered(lambda r: r.sequence == 20)
                    ...
                    bilan_24.write({'year_4': (tcr_3.montant_n / tcr_1.montant_n) * 100 if tcr_1.montant_n != 0 else 0,
                                    ...
                                    'year_2': (tcr_3.montant_n / tcr_1.montant_n) * 100 if tcr_1.montant_n != 0 else 0,
                                    'year_1': (tcr_3.montant_n1 / tcr_1.montant_n1) * 100 if tcr_1.montant_n1 != 0 else 0})

                    # معدل العائد على الموجودات ROA
                    bilan_25 = rec.companies_fisc.filtered(lambda r: r.sequence == 21)
                    bilan_25.write({'year_4': (tcr_3.montant_n / actif_2.montant_n) * 100 if actif_2.montant_n != 0 else 0,
                                    ...
                                    'year_2': (tcr_3.montant_n / actif_2.montant_n) * 100 if actif_2.montant_n != 0 else 0,
                                    'year_1': (tcr_3.montant_n1 / actif_2.montant_n1) * 100 if actif_2.montant_n1 != 0 else 0})

                
                    # معدل العائد على حقوق الملكية ROE
                    bilan_26 = rec.companies_fisc.filtered(lambda r: r.sequence == 22)
                    bilan_26.write({'year_4': (tcr_3.montant_n / passif_1.montant_n) * 100 if passif_1.montant_n != 0 else 0,
                                    ...
                                    'year_2': (tcr_3.montant_n / passif_1.montant_n) * 100 if passif_1.montant_n != 0 else 0,
                                    'year_1': (tcr_3.montant_n1 / passif_1.montant_n1) * 100 if passif_1.montant_n1 != 0 else 0})

                    # التدفقات النقدية التشغيلية
                    bilan_27 = rec.companies_fisc.filtered(lambda r: r.sequence == 23)
                    ...
                    bilan_27.write(
                        ...
                        'year_2': tcr_3.montant_n + tcr_36.montant_n,
                        'year_1': tcr_3.montant_n1 + tcr_36.montant_n1})

                    # نسبة التداول (السيولة)
                    actif_26 = rec.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 26)
                    actif_26 = rec.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 26)
                    bilan_28 = rec.companies_fisc.filtered(lambda r: r.sequence == 24)
                    bilan_28.write({'year_4': (actif_26.montant_n + actif_18.montant_n + actif_20.montant_n) / (passif_5.montant_n + passif_20.montant_n) if passif_5.montant_n + passif_20.montant_n != 0 else 0,
                                    ...
                                    'year_2': (actif_26.montant_n + actif_18.montant_n + actif_20.montant_n) / (passif_5.montant_n + passif_20.montant_n) if passif_5.montant_n + passif_20.montant_n != 0 else 0,
                                    'year_1': (actif_26.montant_n1 + actif_18.montant_n1 + actif_20.montant_n1) / (passif_5.montant_n1 + passif_20.montant_n1) if passif_5.montant_n1 + passif_20.montant_n1 != 0 else 0})

                    #نسبة السيولة السريعة
                    bilan_29 = rec.companies_fisc.filtered(lambda r: r.sequence == 25)
                    bilan_29.write({'year_4': (actif_26.montant_n) / (passif_5.montant_n + passif_20.montant_n) if passif_5.montant_n + passif_20.montant_n != 0 else 0,
                                    ...
                                    'year_2': (actif_26.montant_n) / (passif_5.montant_n + passif_20.montant_n) if passif_5.montant_n + passif_20.montant_n != 0 else 0,
                                    'year_1': (actif_26.montant_n1) / (passif_5.montant_n1 + passif_20.montant_n1) if passif_5.montant_n1 + passif_20.montant_n1 != 0 else 0,
                                    })

                    #حقوق عند الزبائن
                    bilan_30 = rec.companies_fisc.filtered(lambda r: r.sequence == 26)
                    ...
                    bilan_30.write({'year_4': actif_5.montant_n,
                                    ...
                                    'year_2': actif_5.montant_n,
                                    'year_1': actif_5.montant_n1,
                                    })
            

                    # المخزون
                    bilan_31 = rec.companies_fisc.filtered(lambda r: r.sequence == 27)
                    bilan_31.write({'year_4': actif_4.montant_n,
                                    'year_3': actif_4.montant_n1,
                                    'year_2': actif_4.montant_n,
                                    'year_1': actif_4.montant_n1,
                                    })
                

                    #متوسط دوران المخزون (يوم)
                    bilan_32 = rec.companies_fisc.filtered(lambda r: r.sequence == 28)
                    ...
                    bilan_32.write({'year_4': (actif_4.montant_n * 360) / (tcr_5.montant_n + tcr_6.montant_n + tcr_14.montant_n) if (tcr_5.montant_n + tcr_6.montant_n + tcr_14.montant_n) != 0 else 0,
                                    ...
                                    'year_2': (actif_4.montant_n * 360) / (tcr_5.montant_n + tcr_6.montant_n + tcr_14.montant_n) if (tcr_5.montant_n + tcr_6.montant_n + tcr_14.montant_n) != 0 else 0,
                                    'year_1': (actif_4.montant_n1 * 360) / (tcr_5.montant_n1 + tcr_6.montant_n1 + tcr_14.montant_n1) if (tcr_5.montant_n1 + tcr_6.montant_n1 + tcr_14.montant_n1) != 0 else 0,
                                    })
                    
                
                    #متوسط فترة التحصيل (يوم)

                    bilan_33 = rec.companies_fisc.filtered(lambda r: r.sequence == 29)
                    bilan_33.write({'year_4': (actif_5.montant_n * 360) / tcr_1.montant_n if tcr_1.montant_n != 0 else 0,
                                    ...
                                    'year_2': (actif_5.montant_n * 360) / tcr_1.montant_n if tcr_1.montant_n != 0 else 0,
                                    'year_1': (actif_5.montant_n1 * 360) / tcr_1.montant_n1 if tcr_1.montant_n1 != 0 else 0})

                       #متوسط مدة تسهيلات الموردين (يوم)
                    bilan_34 = rec.companies_fisc.filtered(lambda r: r.sequence == 30)
                    bilan_34.write({'year_4': (passif_7.montant_n * 360) / (tcr_5.montant_n + tcr_6.montant_n) if (tcr_5.montant_n + tcr_6.montant_n) != 0 else 0,
                                    ...
                                    'year_2': (passif_7.montant_n * 360) / (tcr_5.montant_n + tcr_6.montant_n) if (tcr_5.montant_n + tcr_6.montant_n) != 0 else 0,
                                    'year_1': (passif_7.montant_n1 * 360) / (tcr_5.montant_n1 + tcr_6.montant_n1) if (tcr_5.montant_n1 + tcr_6.montant_n1) != 0 else 0,
                                    })


    def show_this(self):
         for rec in self:
                etape_id = rec.env['wk.etape'].search([('sequence', '=', 2), 
                                                   ('nom_client', '=', rec.partner_id.id),
                                                   ('workflow', 'in', rec.env['wk.workflow.dashboard'].search([('state', '=', '7')]).ids ),
                                                    ],limit=1)

                for doc in etape_id:
                    for bilan_field in ['bilan1_id', 'bilan2_id', 'bilan3_id', 'bilan4_id', 'bilan5_id']:
                        for doc in etape_id[bilan_field]:
                            if doc:
                                print(doc.declaration,'doc doc doc doc doc')
                    
    def import_data_group(self):
        self.companies_fisc = [(5, 0, 0)]
        company_fisc = []
        for rec in self:
                etape_id = rec.env['wk.etape'].search([('sequence', '=', 2), 
                                                   ('nom_client', '=', rec.partner_id.id),
                ...
                if etape_id.tcr_id.state not in ['valide', 'modified'] or etape_id.actif_id.state not in ['valide', 'modified'] or etape_id.passif_id.state not in ['valide', 'modified']:
                    raise ValidationError("Vous devriez d'abord valider les bilans")
                else:
                    for bilan_field in ['bilan1_id', 'bilan2_id', 'bilan3_id', 'bilan4_id', 'bilan5_id']:
                        for doc in etape_id[bilan_field]:
                            if doc:
                                if doc.declaration != "السنة":
                                    company_fisc.append((0, 0, {
        ...
        self.companies_fisc = company_fisc
    ...
    #             bilan_1 = rec.companies_fisc.filtered(lambda r: r.sequence == 1)
    #             # total I حقوق الملكية
    #             passif_1 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 12)
    #             bilan_1.write({'year_2': passif_1.montant_n,
    #                            'year_1': passif_1.montant_n1,
    #                            'year_4': passif_1.montant_n,
    #                            'year_3': passif_1.montant_n1})

    #             bilan_2 = rec.companies_fisc.filtered(lambda r: r.sequence == 2)
    #             # مجموع الديون
    #             passif_2 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 18)
    #             passif_3 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 24)
    #             bilan_2.write({'year_2': passif_2.montant_n + passif_3.montant_n,
    #                            'year_1': passif_2.montant_n1 + passif_3.montant_n1,
    #                            'year_4': passif_2.montant_n + passif_3.montant_n,
    #                            'year_3': passif_2.montant_n1 + passif_3.montant_n1})
    #             #سبة المديونية leverage
    #             bilan_3 = rec.companies_fisc.filtered(lambda r: r.sequence == 3)
    #             actif_1 = etape_id.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 26)
    #             passif_5 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 23)
    #             passif_6 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 14)
    #             bilan_3.write({'year_2': (passif_6.montant_n + passif_5.montant_n - actif_1.montant_n) / passif_1.montant_n if passif_1.montant_n != 0 else 0,
    #                             'year_1': (passif_6.montant_n1 + passif_5.montant_n1 - actif_1.montant_n1) / passif_1.montant_n1 if passif_1.montant_n1 != 0 else 0,
    #                             'year_4': (passif_6.montant_n + passif_5.montant_n - actif_1.montant_n) / passif_1.montant_n if passif_1.montant_n != 0 else 0,
    #                             'year_3': (passif_6.montant_n1 + passif_5.montant_n1 - actif_1.montant_n1) / passif_1.montant_n1 if passif_1.montant_n1 != 0 else 0})

    #             #Gearing
    #             bilan_4 = rec.companies_fisc.filtered(lambda r: r.sequence == 4)
    #             bilan_4.write({'year_2': ((passif_6.montant_n + passif_5.montant_n) / passif_1.montant_n) * 100 if passif_1.montant_n != 0 else 0,
    #                             'year_1': ((passif_6.montant_n1 + passif_5.montant_n1) / passif_1.montant_n1) * 100 if passif_1.montant_n1 != 0 else 0,
    #                             'year_4': ((passif_6.montant_n + passif_5.montant_n) / passif_1.montant_n) * 100 if passif_1.montant_n != 0 else 0,
    #                             'year_3': ((passif_6.montant_n1 + passif_5.montant_n1) / passif_1.montant_n1) * 100 if passif_1.montant_n1 != 0 else 0})

    #             #رقم الاعمال
    #             bilan_5 = rec.companies_fisc.filtered(lambda r: r.sequence == 5)
    #             tcr_1 = etape_id.tcr_id.tcr_lines.filtered(lambda r: r.rubrique.sequence == 7)
    #             bilan_5.write({'year_2': tcr_1.montant_n,
    #                             'year_1': tcr_1.montant_n1,
    #                             'year_4': tcr_1.montant_n,
    #                             'year_3': tcr_1.montant_n1,
    #                             })
    #             # EBIDTA
    #             tcr_2 = etape_id.tcr_id.tcr_lines.filtered(lambda r: r.rubrique.sequence == 33)
    #             bilan_6 = rec.companies_fisc.filtered(lambda r: r.sequence == 6)
    #             bilan_6.write({'year_2': tcr_2.montant_n,
    #                             'year_1': tcr_2.montant_n1,
    #                             'year_4': tcr_2.montant_n,
    #                             'year_3': tcr_2.montant_n1})

    #             #صافي الربح
    #             bilan_7 = rec.companies_fisc.filtered(lambda r: r.sequence == 7)
    #             tcr_3 = etape_id.tcr_id.tcr_lines.filtered(lambda r: r.rubrique.sequence == 50)
    #             bilan_7.write({'year_2': tcr_3.montant_n,
    #                            'year_1': tcr_3.montant_n1,
    #                            'year_4': tcr_3.montant_n,
    #                            'year_3': tcr_3.montant_n1,})

    #             # راس المال العامل
    #             bilan_8 = rec.companies_fisc.filtered(lambda r: r.sequence == 8)
    #             actif_2 = etape_id.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 16)
    #             passif_18 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 18)
    #             bilan_8.write({'year_2': passif_1.montant_n - actif_2.montant_n,
    #                             'year_1': passif_1.montant_n1 - actif_2.montant_n1,
    #                             'year_4': passif_1.montant_n - actif_2.montant_n,
    ...
    #             passif_4_1 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 24)
    #             passif_20 = etape_id.passif_id.passif_lines.filtered(lambda r: r.rubrique.sequence == 20)
    #             actif_18 = etape_id.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 18)
    #             actif_20 = etape_id.actif_id.actif_lines.filtered(lambda r: r.rubrique.sequence == 20)
    #             bilan_9.write({'year_2': actif_18.montant_n + actif_20.montant_n - passif_20.montant_n,
    #                            'year_1': actif_18.montant_n1 + actif_20.montant_n1 - passif_20.montant_n1,
    #                            'year_4': actif_18.montant_n + actif_20.montant_n - passif_20.montant_n,
    ...
    def calcul_scoring(self):
        for rec in self:
            ...
            rec.quant_7 = (actif_4.montant_n * 360) / ((tcr_3.montant_n + tcr_4.montant_n) * 1.19) if tcr_3.montant_n != 0 else 0 
